...
/* 
 * Referência:
 * Biblioteca clonada do GitHub https://github.com/ocaffe/numero-por-extenso
 * 
 */
...
class Unidade extends Algarismo {
    ...
    private static final String[] unidadePorExtenso = { "", "um", "dois", "três", "quatro", "cinco", "seis", "sete",
            "oito", "nove" };
...
class Dezena extends Algarismo {
    ...
    private static final String[] dezenaPorExtenso = { "", "dez", "vinte", "trinta", "quarenta", "cinquenta",
            "sessenta", "setenta", "oitenta", "noventa" };

    private static final String[] onzeADezenove = { "", "onze", "doze", "treze", "quatorze", "quinze", "dezesseis",
